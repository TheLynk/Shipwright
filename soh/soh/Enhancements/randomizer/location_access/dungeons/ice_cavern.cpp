...
#pragma region Vanilla
    ...
    areaTable[RR_ICE_CAVERN_COMPASS_ROOM] = Region("Ice Cavern Map Room", SCENE_ICE_CAVERN, {
        ...
        //Locations
        LOCATION(RC_ICE_CAVERN_COMPASS_CHEST,       logic->CanClearStalagmite() && logic->BlueFire() && logic->HasItem(RG_OPEN_CHEST)),
    ...
    areaTable[RR_ICE_CAVERN_FINAL_ROOM] = Region("Ice Cavern Final Room", SCENE_ICE_CAVERN, {}, {
        //Locations
        LOCATION(RC_ICE_CAVERN_IRON_BOOTS_CHEST, Here(RR_ICE_CAVERN_FINAL_ROOM, []{return logic->CanKillEnemy(RE_WOLFOS) && logic->HasItem(RG_OPEN_CHEST);})),
        LOCATION(RC_SHEIK_IN_ICE_CAVERN,         Here(RR_ICE_CAVERN_FINAL_ROOM, []{return logic->CanKillEnemy(RE_WOLFOS) && logic->HasItem(RG_OPEN_CHEST);})), // rando enables this for child
    }, {
        //Exits
