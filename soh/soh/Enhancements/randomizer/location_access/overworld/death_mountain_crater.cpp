...
void RegionTable_Init_DeathMountainCrater() {
    ...
    areaTable[RR_DMC_UPPER_NEARBY] = Region("DMC Upper Nearby", SCENE_DEATH_MOUNTAIN_CRATER, {}, {
        LOCATION(RC_DMC_CIRCLE_ROCK_1, logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMC_CIRCLE_ROCK_2, logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMC_CIRCLE_ROCK_3, logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMC_CIRCLE_ROCK_4, logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMC_CIRCLE_ROCK_5, logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMC_CIRCLE_ROCK_6, logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMC_CIRCLE_ROCK_7, logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMC_CIRCLE_ROCK_8, logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMC_GOSSIP_ROCK_1, logic->IsChild && (logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash())),
        LOCATION(RC_DMC_GOSSIP_ROCK_2, logic->IsChild && (logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash())),
    ...
    areaTable[RR_DMC_CENTRAL_LOCAL] = Region("DMC Central Local", SCENE_DEATH_MOUNTAIN_CRATER, {
        ...
        LOCATION(RC_DMC_ROCK_BY_FIRE_TEMPLE_1,        logic->IsAdult && (logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash())),
        LOCATION(RC_DMC_ROCK_BY_FIRE_TEMPLE_2,        logic->IsAdult && (logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash())),
        LOCATION(RC_DMC_ROCK_BY_FIRE_TEMPLE_3,        logic->IsAdult && (logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash())),
        LOCATION(RC_DMC_ROCK_BY_FIRE_TEMPLE_4,        logic->IsAdult && (logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash())),
        LOCATION(RC_DMC_ROCK_BY_FIRE_TEMPLE_5,        logic->IsAdult && (logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash())),
    }, {
        //Exits
