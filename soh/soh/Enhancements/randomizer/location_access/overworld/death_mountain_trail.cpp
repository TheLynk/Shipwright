...
void RegionTable_Init_DeathMountainTrail() {
    ...
    areaTable[RR_DEATH_MOUNTAIN_TRAIL] = Region("Death Mountain", SCENE_DEATH_MOUNTAIN_TRAIL, {
        ...
        LOCATION(RC_DMT_ROCK_1,                   logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMT_ROCK_2,                   logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMT_ROCK_3,                   logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMT_ROCK_4,                   logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMT_ROCK_5,                   logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMT_CIRCLE_ROCK_1,            logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMT_CIRCLE_ROCK_2,            logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMT_CIRCLE_ROCK_3,            logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMT_CIRCLE_ROCK_4,            logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMT_CIRCLE_ROCK_5,            logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMT_CIRCLE_ROCK_6,            logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMT_CIRCLE_ROCK_7,            logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_DMT_CIRCLE_ROCK_8,            logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
