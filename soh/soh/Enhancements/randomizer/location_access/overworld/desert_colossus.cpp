...
void RegionTable_Init_DesertColossus() {
    ...
    areaTable[RR_DESERT_COLOSSUS] = Region("Desert Colossus", SCENE_DESERT_COLOSSUS, {
        ...
        LOCATION(RC_COLOSSUS_ROCK,                   logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_1_ROCK_1,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_1_ROCK_2,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_1_ROCK_3,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_1_ROCK_4,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_1_ROCK_5,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_1_ROCK_6,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_1_ROCK_7,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_1_ROCK_8,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_2_ROCK_1,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_2_ROCK_2,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_2_ROCK_3,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_2_ROCK_4,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_2_ROCK_5,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_2_ROCK_6,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_2_ROCK_7,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_COLOSSUS_CIRCLE_2_ROCK_8,        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
