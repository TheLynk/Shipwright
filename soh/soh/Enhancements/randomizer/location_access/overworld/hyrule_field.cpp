...
void RegionTable_Init_HyruleField() {
    ...
    areaTable[RR_HYRULE_FIELD] = Region("Hyrule Field", SCENE_HYRULE_FIELD, {
        ...
        LOCATION(RC_HF_SOUTHEAST_TREE_14, logic->IsChild && logic->CanBonkTrees()),
        LOCATION(RC_HF_SOUTHEAST_TREE_15, logic->IsChild && logic->CanBonkTrees()),
        LOCATION(RC_HF_SOUTHEAST_TREE_16, logic->IsChild && logic->CanBonkTrees()),
        ...
        Entrance(RR_HF_TO_LAKE_HYLIA,       []{return logic->HasItem(RG_CLIMB) || logic->CanUse(RG_HOOKSHOT) || logic->CanUse(RG_EPONA);}),
    ...
    areaTable[RR_HF_TO_LAKE_HYLIA] = Region("HF to Lake Hylia", SCENE_HYRULE_FIELD, {}, {}, {
        ...
        Entrance(RR_HYRULE_FIELD, []{return logic->HasItem(RG_CLIMB) || logic->CanUse(RG_HOOKSHOT) || logic->CanUse(RG_EPONA);}),
    });
