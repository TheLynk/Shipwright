...
void RegionTable_Init_HyruleField() {
    ...
    areaTable[RR_HYRULE_FIELD] = Region("Hyrule Field", SCENE_HYRULE_FIELD, {
        ...
        LOCATION(RC_HF_ROCK_1,                 logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_HF_ROCK_2,                 logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_HF_ROCK_3,                 logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_HF_ROCK_4,                 logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_HF_ROCK_5,                 logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_HF_ROCK_6,                 logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_HF_ROCK_7,                 logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_HF_ROCK_8,                 logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
