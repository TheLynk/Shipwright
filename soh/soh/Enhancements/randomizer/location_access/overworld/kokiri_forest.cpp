...
void RegionTable_Init_KokiriForest() {
    ...
    areaTable[RR_KOKIRI_FOREST] = Region("Kokiri Forest", SCENE_KOKIRI_FOREST, {
        ...
        LOCATION(RC_KF_CHILD_GRASS_MAZE_1,      logic->IsChild && logic->CanCutShrubs() && logic->CanUse(RG_CRAWL)),
        LOCATION(RC_KF_CHILD_GRASS_MAZE_2,      logic->IsChild && logic->CanCutShrubs() && logic->CanUse(RG_CRAWL)),
        LOCATION(RC_KF_CHILD_GRASS_MAZE_3,      logic->IsChild && logic->CanCutShrubs() && logic->CanUse(RG_CRAWL)),
        ...
        //Exits
        Entrance(RR_KF_LINKS_PORCH,        []{return logic->HasItem(RG_CLIMB);}),
        ...
        Entrance(RR_KF_OUTSIDE_LOST_WOODS,    []{return logic->IsAdult || logic->HasItem(RG_CLIMB);}),
