...
void RegionTable_Init_ZoraRiver() {
    ...
    areaTable[RR_ZORAS_RIVER] = Region("Zora River", SCENE_ZORAS_RIVER, {
        ...
        LOCATION(RC_ZR_CIRCLE_ROCK_1,                        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_CIRCLE_ROCK_2,                        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_CIRCLE_ROCK_3,                        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_CIRCLE_ROCK_4,                        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_CIRCLE_ROCK_5,                        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_CIRCLE_ROCK_6,                        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_CIRCLE_ROCK_7,                        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_CIRCLE_ROCK_8,                        logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_UPPER_CIRCLE_BOULDER,                 logic->BlastOrSmash()),
        LOCATION(RC_ZR_UPPER_CIRCLE_ROCK_1,                  logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_UPPER_CIRCLE_ROCK_2,                  logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_UPPER_CIRCLE_ROCK_3,                  logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_UPPER_CIRCLE_ROCK_4,                  logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_UPPER_CIRCLE_ROCK_5,                  logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_UPPER_CIRCLE_ROCK_6,                  logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_UPPER_CIRCLE_ROCK_7,                  logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_UPPER_CIRCLE_ROCK_8,                  logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
        LOCATION(RC_ZR_ROCK,                                 logic->HasItem(RG_POWER_BRACELET) || logic->BlastOrSmash()),
