...
#define DEFINE_ENEMY_DISTANCE(enum) enum,
typedef enum {
    ED_NONE,
...
#define DEFINE_RANDOMIZER_CHECK(enum) enum,
typedef enum {
    RC_UNKNOWN_CHECK,
...
#define DEFINE_RANDOMIZER_ENEMY(enum) enum,
typedef enum {
    RE_NONE,
...
#define DEFINE_RANDOMIZER_GET(enum) enum,
typedef enum {
    RG_NONE,
...
#define DEFINE_RANDOMIZER_TRICK(enum) enum,
typedef enum {
    RT_NONE,
...
#define DEFINE_RANDOMIZER_REGION(enum) enum,
typedef enum {
    RR_NONE,
...
#define DEFINE_RANDO_WATER_LEVEL(enum) enum,
typedef enum {
    WL_NONE,
...
#define DEFINE_RANDOMIZER_SETTING_KEY(enum) enum,
typedef enum {
    RSK_NONE,
